...
-- Basic options
cmd:option('-batch_size', 8, 'if > 0 then override, otherwise load from checkpoint.')
...
cmd:option('-input_h5','../coco_data/cocotalk.h5','path to the h5file containing the preprocessed dataset. empty = fetch from model checkpoint.')
cmd:option('-input_json','../coco_data/cocotalk.json','path to the json file containing additional info and vocab. empty = fetch from model checkpoint.')
...
-- dump the result of the predictions on the test images 
